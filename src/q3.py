# q3.py
# Query 3: Compute the average number of new tests on days where the positive rate is above average
# Only consider rows where new_tests and positive_rate are not empty
